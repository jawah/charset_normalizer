...
# Pre-computed "tribal knowledge" ordered encoding list: multibyte first, then single-byte.
...
# The list is computed by `bin/compute_iana_supported_mb_first.py`.
IANA_SUPPORTED_MB_FIRST: list[str] = [
    "big5",
    "big5hkscs",
    "cp932",
    "cp949",
