...
def performance_compare(arguments):
    ...
    print("   --> Avg: " + str(round((chardet_avg_delay / charset_normalizer_avg_delay * 100), 2)) + "%")        
    print("   --> 99th: " + str(round((chardet_99p / charset_normalizer_99p * 100), 2)) + "%")
    print("   --> 95th: " + str(round((chardet_95p / charset_normalizer_95p * 100), 2)) + "%")
    print("   --> 50th: " + str(round((chardet_50p / charset_normalizer_50p * 100), 2)) + "%")
