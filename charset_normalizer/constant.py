...
ENCODING_MARKS: Dict[str, Union[bytes, List[bytes]]] = OrderedDict(
    [
        ("utf_8", BOM_UTF8),
        (
            "utf_7",
...
RE_POSSIBLE_ENCODING_INDICATION: Pattern = re_compile(
...
NOT_PRINTABLE_PATTERN: Pattern = re_compile(r"[0-9\W\n\r\t]+")
